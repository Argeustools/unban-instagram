...
if message_contact == "":
    message_contact = " "Based on your terms and conditions, and the laws of Kosovo and Europe which makes us available and eligible to use your services, we hereby ask you to make another human review on the aformeintioned account since we are really felling tired and bad physically because that account is very valuable to us since it has photos ,people, family members ,and dear friends" 
